...
public class DisPAtom implements Runnable {
    ...
    private boolean makeFile(String symbol) {
        ...
        String query = "select price, volume, event_time from ptable where "
                + "event_date > '" + maxDate + "' "
        ...
        if (al.size() == 0) {
            ...
            try {
                ...
                String zipFilePath = outputFolder + sep + "P_" + symbol + ".zip";
                created = true;
